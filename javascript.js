...
form.addEventListener("submit", (event) =>
 { event.preventDefault()  
    ...
    if(nameInmput.value === "") {alert("Por favor, preencha seu nome");return;
}
 if (emailinmput.value ===""|| !isEmailValid(emailinmput.value)) {alert("Por favor, preencha seu email");return
